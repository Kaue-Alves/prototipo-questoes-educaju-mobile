...
import { SetupScreen, StudyingScreen, QuizScreen, ResultsScreen } from '@/screens';
import { Stage, Question, QuizResults } from '@/types';
  ...
  const generateQuestions = useCallback(async () => {
    ...
    try {
      ...
      if (!contentType || !contentType.includes('application/json')) {
        ...
        console.error('[Mobile] Expected JSON but got:', textResponse.substring(0, 200));
